...
- `Test-Tool.ps1` : 37 tests du moteur ; modifications Windows simulées.
...
- `Test-Site.ps1` : 52 assertions dans Chrome ou Edge sans interface, avec profil temporaire isolé. Utiliser `-BrowserPath` pour indiquer un autre emplacement du navigateur.
